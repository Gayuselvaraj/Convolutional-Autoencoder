...
### Model Summary
<img width="845" height="503" alt="image" src="https://github.com/user-attachments/assets/50e66121-2eaa-49fa-8285-7057ce773a6d" />


### Original vs Noisy Vs Reconstructed Image
<img width="1513" height="820" alt="image" src="https://github.com/user-attachments/assets/f66c8f7d-e8a5-4b04-a6c9-58d9a95e4b28" />
...
## RESULT
The convolutional autoencoder was successfully trained on the MNIST dataset and effectively removed Gaussian noise from the images, producing clear reconstructed outputs close to the original digits.
